    ...
    public static class RunPhaseDefaults
    {
        public static readonly RunPhaseSettings[] All =
        {
            ...
            new RunPhaseSettings
            {
                ...
                groundColor = new Color(0.78f, 0.62f, 0.32f),
                wallColor = new Color(0.62f, 0.45f, 0.22f),
                accentColor = new Color(0.95f, 0.55f, 0.18f),
                ambientColor = new Color(0.72f, 0.58f, 0.35f),
