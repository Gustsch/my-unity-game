...
namespace KnightRun.Gameplay
{
    public class ShieldPickup : MonoBehaviour
    {
        ...
        public const int AbsorbAmount = 100;
        public const float DurationSeconds = 10f;

        static readonly Color PickupColor = new Color(0.35f, 0.85f, 0.95f);
        ...
        public static void Spawn(Vector3 position)
        {
            ...
            go.AddComponent<ShieldPickup>().Build();
        }
        ...
        void Build()
        {
            ...
            mesh.transform.localScale = new Vector3(0.55f, 0.12f, 0.55f);
        ...
        void Update()
        {
            ...
            if (meshTransform != null)
                meshTransform.Rotate(Vector3.up, 100f * Time.deltaTime, Space.World);
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            PlayerShieldController.Activate(AbsorbAmount, DurationSeconds);
            Destroy(gameObject);
        }
    }
}
